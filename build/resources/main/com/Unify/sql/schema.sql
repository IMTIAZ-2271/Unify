...
--
CREATE DATABASE IF NOT EXISTS Unify CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE Unify;
...
CREATE TABLE `book_issues` (
                               ...
                               `status` enum('pending','issued','returned','rejected') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `buses` (
                         `bus_number` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
                         `route_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
                         `departure_time` time NOT NULL,
                         `trip_type` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `canteen_orders_tbl` (
                                      ...
                                      `order_batch_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `events` (
                          ...
                          `event_type` enum('personal','group') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'personal',
...
CREATE TABLE `group_members` (
                                 ...
                                 `last_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                                 `assigned_work` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
                                 PRIMARY KEY (`id`),
...
CREATE TABLE `groups_tbl` (
                              ...
                              `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
                              `last_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
                              `messaging_permission` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'ALL',
                              PRIMARY KEY (`id`),
...
-- Dump completed on 2026-04-03 21:19:50
