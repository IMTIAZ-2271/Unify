...
public class GroupsController {
    ...
    @FXML private VBox      myGroupsList;
    ...
    @FXML private void loadMyGroups() {
        myGroupsList.getChildren().clear();
        try {
            List<Group> groups = groupDAO.myGroups(Session.uid());
            if (groups.isEmpty()) { myGroupsList.getChildren().add(noData("No groups yet.")); return; }
    ...
    @FXML private void doSearch() {
        ...
        try {
            ...
            if (groups.isEmpty()) { searchResultsList.getChildren().add(noData("No groups found.")); return; }
    ...
    private void loadRequests() {
        ...
        try {
            ...
            if (reqs.isEmpty()) { requestsList.getChildren().add(noData("No pending requests.")); return; }
    ...
    private HBox groupCard(Group g) {
        ...
        av.setFitWidth(48); av.setFitHeight(48);
    ...
    private HBox requestCard(JoinRequest r) {
        ...
        ImageView av = new ImageView();
        av.setFitWidth(40); av.setFitHeight(40);
        ...
        HBox.setHgrow(info, Priority.ALWAYS);
        Label n = new Label(r.getDisplayName()); n.setStyle("-fx-font-weight:bold;");
        Label g = new Label("Wants to join: " + r.getGroupName()); g.setStyle("-fx-text-fill:#666;-fx-font-size:11;");
