...
public class Group {
    ...
    public void setParentGroupId(Integer v)     { this.parentGroupId = v; }
    public String getParentGroupName()          { return parentGroupName; }
    public void setParentGroupName(String v)    { this.parentGroupName = v; }
    ...
    public void setCurrentUserRole(String v)    { this.currentUserRole = v; }

    public boolean isAdmin()  { return "admin".equals(currentUserRole); }
    public boolean isMember() { return currentUserRole != null; }

    @Override public String toString() { return name + " [" + groupCode + "]"; }
}
